...
- Implement a solution with _kstreams, flink, ksql, spark, NiFi, kafka APIs, camel-kafka, spring-kafka..._ reading input data from _measurements_ topic and sink result to _results_ topics. and **run it!**. This is not limited to JAVA!
