...
docker exec -it kafka1 kafka-topics --bootstrap-server kafka1:9092 --create --topic measurements --replication-factor 3 --partitions 32 --config message.timestamp.type=LogAppendTime
