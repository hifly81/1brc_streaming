...
def process_chunk(chunk, producer, topic):
    sendToKafka(chunk, producer, topic)

def sendMessages(bootstrap_servers, topic, csv_file_path):
    producer = Producer({
...
def sendToKafka(chunk, producer, topic):
...
if __name__ == "__main__":
    ...
    sendMessages(kafka_bootstrap_servers, kafka_topic, csv_file_path)
